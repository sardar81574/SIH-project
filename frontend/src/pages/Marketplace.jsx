...
// // 10 Dynamic Background Color Palettes (Switching Every 1 Second)
...
// ========================================================================= */
// const marketplaceProducts = [
//   // 🌿 NEW ADDITION: KAPIQ HERBICIDE
//   {
//     id: 'med-kapiq-1',
//     category: 'medicines',
//     cropType: 'sugarcane',
//     nameEn: 'Kapiq Herbicide (Paraquat Dichloride 24% SL)',
//     nameHi: 'कापिक खरपतवारनाशक (पैराक्वाट डाईक्लोराइड 24% SL)',
//     targetEn: 'Non-Selective Broadleaf & Grassy Weeds',
//     targetHi: 'चौड़ी व संकरी पत्ती वाले जिद्दी खरपतवार',
//     descEn: 'Fast-acting contact herbicide that clears unwanted green vegetation within hours.',
//     descHi: 'संपर्क आधारित तीव्र खरपतवारनाशक जो छिड़काव के कुछ ही घंटों में खरपतवार सुखा देता है।',
//     doseEn: '75-100 ml per 15L spray pump (600-800 ml per acre)',
//     doseHi: '75 से 100 मिली प्रति 15 लीटर पंप (600-800 मिली प्रति एकड़)',
//     price: 380,
//     unitEn: '1 Litre Bottle',
//     unitHi: '1 लीटर बॉटल',
//     rating: 4.8,
//     reviews: 154,
//     badgeEn: 'Weed Destroyer',
//     badgeHi: 'खरपतवार संहारक',
//     image: '/image/kapiq.jpg'
//   },

//   // 🌿 NEW ADDITION: HAMLA 550 INSECTICIDE
//   {
//     id: 'med-hamla-1',
//     category: 'medicines',
//     cropType: 'chickpea',
//     nameEn: 'Hamla 550 (Chlorpyrifos 50% + Cypermethrin 5% EC)',
//     nameHi: 'हमला 550 कीटनाशक (घारडा केमिकल्स)',
//     targetEn: 'Pod Borer, Aphids, Caterpillars, Girdle Beetle',
//     targetHi: 'इल्ली, सुंडी, तना छेदक व रस चूसक कीट',
//     descEn: 'Dual-action contact and stomach poison insecticide for quick knockdown of tough pests.',
//     descHi: 'दोहरा असरदार कीटनाशक जो चने की इल्ली और तना छेदक कीटों को तुरंत समाप्त करता है।',
//     doseEn: '30-35 ml per 15L water tank (350-400 ml per acre)',
//     doseHi: '30 से 35 मिली प्रति 15L पंप (350-400 मिली प्रति एकड़)',
//     price: 460,
//     unitEn: '500ml Bottle',
//     unitHi: '500 मिली बॉटल',
//     rating: 4.9,
//     reviews: 320,
//     badgeEn: 'Dual Attack',
//     badgeHi: 'दोहरा हमला',
//     image: '/image/hamla.jpg'
//   },

//   // 🌿 NEW ADDITION: BIFEN FORCE INSECTICIDE
//   {
//     id: 'med-bifen-1',
//     category: 'medicines',
//     cropType: 'paddy',
//     nameEn: 'Bifen Force (Bifenthrin 10% EC - Mankind)',
//     nameHi: 'बायफेन फ़ोर्स (बायफेंथ्रिन 10% EC - मैनकाइंड)',
//     targetEn: 'Stem Borer, Termites, Leaf Folder, Whitefly',
//     targetHi: 'दीमक, तना छेदक, पत्ती लपेटक व सफेद मक्खी',
//     descEn: 'Broad-spectrum synthetic pyrethroid with long soil residual termite and borer defense.',
//     descHi: 'दीमक और रस चूसक कीटों पर लंबा सुरक्षा कवच, मिट्टी व जड़ों में उत्कृष्ट बॉन्डिंग।',
//     doseEn: '25-30 ml per 15L water tank (250-300 ml per acre)',
//     doseHi: '25 से 30 मिली प्रति 15 लीटर पंप (250-300 मिली प्रति एकड़)',
//     price: 520,
//     unitEn: '500ml Pack',
//     unitHi: '500 मिली पैक',
//     rating: 4.8,
//     reviews: 198,
//     badgeEn: 'Termite & Borer Shield',
//     badgeHi: 'दीमक व कीट रक्षक',
//     image: '/image/bifen force.jpg'
//   },
...
//     badgeEn: 'Export Grade',
//     badgeHi: 'निर्यात गुणवत्ता',
//     image: '/image/dhan.jpg' // ✅ Paddy Seeds Image
//   },
//   {
//     id: 'p-med-1',
//     category: 'medicines',
...
//     badgeEn: 'High Yield',
//     badgeHi: 'बंपर पैदावार',
//     image: '/image/chana2.jpg' // ✅ Kabuli Dollar Chana Image
//   },

//   // 🌾 CHICKPEA / GRAM (DESI CHANA)
//   {
//     id: 'c-seed-2',
//     category: 'seeds',
//     cropType: 'chickpea',
//     nameEn: 'Desi Bengal Gram Certified Seeds (JG-16)',
//     nameHi: 'देसी चना उन्नत बीज (JG-16)',
//     targetEn: 'High Drought & Wilt Tolerant',
//     targetHi: 'सूखा व उकठा रोग सहनशील',
//     descEn: 'High-branching bold brown grain suitable for all soil types.',
//     descHi: 'गहरे भूरे दाने, कम पानी में अधिक उत्पादन, उत्तम दाल रिकवरी।',
//     price: 4800,
//     unitEn: 'per 50kg Bag',
//     unitHi: 'प्रति 50 किग्रा बैग',
//     rating: 4.9,
//     reviews: 112,
//     badgeEn: 'Top Seller',
//     badgeHi: 'लोकप्रिय देसी',
//     image: '/image/chana1.jpg' // ✅ Desi Chana Seeds Image
//   },
...
//     category: 'seeds',
//     cropType: 'wheat',
//     nameEn: 'Certified Sharbati & Lokwan Wheat Seeds',
//     nameHi: 'प्रमाणित शरबती व लोकवन गेहूं बीज',
//     targetEn: 'Resistant to Yellow & Brown Rust',
//     targetHi: 'पीला व भूरा रतुआ (गेरुआ) रोधी',
//     descEn: 'Golden lustrous bold grains with excellent milling & chapati quality.',
//     descHi: 'चमकदार सुनहरे दाने, स्वादिष्ट चपाती गुणवत्ता, भरपूर बालियां।',
//     price: 2150,
//     unitEn: 'per 40kg Bag',
//     unitHi: 'प्रति 40 किग्रा बैग',
//     rating: 4.9,
//     reviews: 215,
//     badgeEn: 'Golden Grain',
//     badgeHi: 'चमकदार दाना',
//     image: '/image/wheat1.jpg' // ✅ Wheat Seeds Image
//   },
...
//     badgeEn: 'Heavy Cob',
//     badgeHi: 'ठोस भुट्टा',
//     image: '/image/wheat1.jpg' // ✅ Maize / Corn Seeds Image
//   },
//   {
//     id: 'm-med-1',
//     category: 'medicines',
...
//     badgeEn: 'Virus Free',
//     badgeHi: 'वायरस रोधी',
//     image: '/image/soyabean1.jpg' // ✅ Soybean Seeds Image
//   },
...
//   // 1-Second Smooth Background Color Rotation (Synchronized with Dashboard)
//   useEffect(() => {
...
//   // Firestore Sync & Notification Injection
//   const saveOrderToDatabase = async (paymentRefId = 'COD_OR_LOCAL') => {
//     try {
//       setIsSubmitting(true);
//       const payload = {
...
//         await addDoc(collection(db, "notifications"), {
//           title: "Agri Order Placed",
//           message: `Order total ₹${totalAmount.toLocaleString('en-IN')} confirmed. Ref: ${paymentRefId}`,
//           type: "order",
//           actionUrl: "/marketplace",
//           isRead: false,
//           createdAt: serverTimestamp()
...
//   const handlePaymentExecution = () => {
//     if (!window.Razorpay) {
//       alert(lang === 'hi' ? 'पेमेंट गेटवे लोड हो रहा है, कृपया 2 सेकंड बाद पुनः प्रयास करें।' : 'Payment gateway is loading, please retry in 2 seconds.');
//       return;
//     }

//     const options = {
//       key: "rzp_test_51NgU7u52JbC6G", // Official Razorpay Test Key for AgriScan Demo
//       amount: totalAmount * 100, // paise me
//       currency: "INR",
//       name: "AgriScan Precision Mart",
//       description: lang === 'hi' ? "प्रमाणित बीज व फसल दवा खरीद" : "Procurement of Agricultural Chemicals & Seeds",
//       image: "/image/1000201393.jpg",
//       handler: function (response) {
//         saveOrderToDatabase(response.razorpay_payment_id || 'RZP_TXN_VERIFIED');
//       },
//       prefill: {
//         name: formData.name,
//         contact: formData.phone,
...
//       alert((lang === 'hi' ? 'भुगतान असफल: ' : 'Payment Failed: ') + (response.error.description || 'Cancelled'));
//     });
//     rzp.open();
//   };
...
//     e.preventDefault();
//     if (!formData.name || !formData.phone || !formData.address || !formData.pincode) {
//       alert(lang === 'hi' ? 'कृपया सभी आवश्यक जानकारी भरें।' : 'Please fill all details.');
//       return;
//     }
...
//   const currentBgColor = isDarkMode ? dynamicDarkColors[colorIndex] : dynamicLightColors[colorIndex];

//   return (
//     <div 
//       style={{ backgroundColor: currentBgColor }}
//       className={`w-full min-h-screen font-sans pb-28 transition-colors duration-1000 ease-in-out ${
//         isDarkMode ? 'text-white' : 'text-slate-900'
//       }`}
//     >
      
//       {/* 🌟 TOP NAVIGATION & CONTROL BAR */}
//       <div className={`sticky top-16 z-30 border-b backdrop-blur-md transition-colors duration-500 shadow-2xs ${
...
//                 value={searchTerm}
//                 onChange={e => setSearchTerm(e.target.value)}
//                 className={`w-full pl-8.5 pr-3 py-1.5 rounded-xl text-xs font-semibold outline-none border transition ${
//                   isDarkMode 
//                     ? 'bg-slate-900 border-slate-800 text-white focus:border-emerald-500' 
//                     : 'bg-slate-50 border-slate-200 text-slate-900 focus:border-emerald-800 focus:bg-white'
//                 }`}
//               />
//             </div>
...
//             <button
//               onClick={() => setLang(lang === 'hi' ? 'en' : 'hi')}
//               className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-black transition border active:scale-95 ${
//                 isDarkMode 
...
//             <button
//               onClick={() => setIsCheckoutOpen(true)}
//               className="relative flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 text-white px-3.5 py-1.5 rounded-xl text-xs font-black shadow-xs transition active:scale-95 shrink-0"
//             >
//               <ShoppingCart className="w-3.5 h-3.5" />
//               <span>{lang === 'hi' ? 'कार्ट' : 'Cart'} ({cart.reduce((a, b) => a + b.qty, 0)})</span>
//               {cart.length > 0 && (
...
//             <div
//               key={product.id}
//               className={`rounded-2xl border overflow-hidden shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between ${
//                 isDarkMode 
...
//                     {lang === 'hi' ? product.badgeHi : product.badgeEn}
//                   </span>
//                   <span className="absolute bottom-2.5 right-2.5 bg-white/95 text-slate-900 text-xs font-black px-2 py-0.5 rounded-md flex items-center gap-1 shadow-xs">
//                     <Star className="w-3 h-3 text-amber-500 fill-amber-500" />
//                     <span>{product.rating}</span>
//                     <span className="text-[10px] text-slate-400 font-normal">({product.reviews})</span>
//                   </span>
...
//                 <div className="p-4.5 space-y-2">
//                   <div className={`inline-flex items-center gap-1 text-[9px] font-black uppercase px-2 py-0.5 rounded ${
//                     isDarkMode ? 'text-emerald-400 bg-emerald-950/60' : 'text-emerald-800 bg-emerald-50'
//                   }`}>
//                     <Tag className="w-2.5 h-2.5" />
//                     <span>{product.cropType}</span>
//                   </div>
...
//                   <div className={`border rounded-xl p-2 text-xs space-y-0.5 ${
//                     isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'
//                   }`}>
//                     <span className="text-[10px] font-bold text-slate-400 block uppercase">
//                       {lang === 'hi' ? 'लक्षित रोग / प्रतिरोधी क्षमता:' : 'Target Disease / Trait:'}
//                     </span>
//                     <p className={`font-bold text-[11px] ${isDarkMode ? 'text-emerald-400' : 'text-slate-800'}`}>
//                       {lang === 'hi' ? product.targetHi : product.targetEn}
//                     </p>
//                   </div>

//                   {product.doseEn && (
//                     <p className={`text-[10px] font-medium p-1.5 rounded-lg border ${
//                       isDarkMode 
...
//                       {lang === 'hi' ? product.unitHi : product.unitEn}
//                     </span>
//                     <span className={`text-xl font-black ${isDarkMode ? 'text-emerald-400' : 'text-slate-900'}`}>
//                       ₹{product.price.toLocaleString('en-IN')}
//                     </span>
//                   </div>
//                 </div>
...
//                 <button
//                   onClick={() => addToCart(product)}
//                   className="w-full bg-emerald-600 hover:bg-emerald-500 text-white py-2.5 rounded-xl text-xs font-black transition active:scale-95 flex items-center justify-center gap-1.5 shadow-xs"
//                 >
//                   <ShoppingCart className="w-3.5 h-3.5" />
//                   <span>{lang === 'hi' ? 'कार्ट में जोड़ें' : 'Add to Cart'}</span>
//                 </button>
...
//       {isCheckoutOpen && (
//         <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex justify-end">
//           <div className={`w-full max-w-md h-full overflow-y-auto p-6 flex flex-col justify-between shadow-2xl transition-colors duration-300 ${
...
//                   </h2>
//                 </div>
//                 <button onClick={() => setIsCheckoutOpen(false)} className="p-1.5 text-slate-400 hover:text-slate-200">
//                   <X className="w-4 h-4" />
//                 </button>
//               </div>
...
//                   </p>
//                   {placedOrderId && (
//                     <div className="bg-slate-950 border border-slate-800 p-2 rounded-xl text-[11px] font-mono text-emerald-400">
//                       Order ID: #{placedOrderId}
//                     </div>
//                   )}
//                   <button
...
//                       setIsCheckoutOpen(false);
//                     }}
//                     className="mt-3 bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-2 rounded-xl text-xs font-black"
//                   >
//                     {lang === 'hi' ? 'शॉपिंग जारी रखें' : 'Continue Shopping'}
//                   </button>
//                 </div>
...
//                       }`}>
//                         <div className="flex items-center gap-2.5">
//                           <img src={item.image} alt={item.nameEn} className="w-10 h-10 object-contain rounded-lg bg-black" />
//                           <div>
//                             <h4 className="text-xs font-black truncate max-w-[130px]">
//                               {lang === 'hi' ? item.nameHi : item.nameEn}
//                             </h4>
//                             <p className="text-[10px] font-bold text-slate-400">₹{item.price} x {item.qty}</p>
//                           </div>
//                         </div>

//                         <div className="flex items-center gap-1.5">
//                           <button onClick={() => updateQty(item.id, -1)} className={`p-1 rounded border ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
//                             <Minus className="w-2.5 h-2.5" />
//                           </button>
//                           <span className="text-xs font-black px-1">{item.qty}</span>
//                           <button onClick={() => updateQty(item.id, 1)} className={`p-1 rounded border ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
...
//                   {/* Shipping Form */}
//                   <form id="orderForm" onSubmit={handleOrderSubmit} className="space-y-3 pt-3 border-t border-slate-200 dark:border-slate-800">
//                     <h4 className="text-[10px] font-black uppercase text-slate-400 tracking-wider">
//                       {lang === 'hi' ? 'डिलीवरी संपर्क विवरण' : 'Shipping Information'}
//                     </h4>
...
//                         {lang === 'hi' ? 'किसान का नाम' : 'Farmer Name'}
//                       </label>
//                       <div className={`flex items-center gap-2 px-3 rounded-xl border ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'}`}>
//                         <User className="w-3.5 h-3.5 text-slate-400" />
//                         <input
//                           type="text"
//                           required
...
//                         {lang === 'hi' ? 'गाँव / खेत का पूरा पता' : 'Village / Farm Address'}
//                       </label>
//                       <div className={`flex items-start gap-2 p-2 rounded-xl border ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'}`}>
//                         <MapPin className="w-3.5 h-3.5 text-slate-400 mt-0.5" />
//                         <textarea
//                           rows={2}
//                           required
...
//                         value={formData.pincode}
//                         onChange={e => setFormData({ ...formData, pincode: e.target.value.replace(/\D/g, '') })}
//                         className={`w-full py-2 px-3 rounded-xl text-xs font-semibold outline-none border ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'}`}
//                         placeholder="482001"
//                       />
//                     </div>
...
//                       </label>
//                       <div className="grid grid-cols-2 gap-2">
//                         <label className={`flex items-center gap-2 p-2.5 rounded-xl border text-xs font-black cursor-pointer transition ${
...
//                           <div>
//                             <span className="block">{lang === 'hi' ? 'ऑनलाइन UPI/कार्ड' : 'Pay Online'}</span>
//                             <span className="text-[8px] text-slate-400 font-normal block">Razorpay Gateway</span>
//                           </div>
//                         </label>
...
//                           <div>
//                             <span className="block">{lang === 'hi' ? 'कैश ऑन डिलीवरी' : 'Pay on Delivery'}</span>
//                             <span className="text-[8px] text-slate-400 font-normal block">{lang === 'hi' ? 'घर पर नकद' : 'Cash on doorstep'}</span>
//                           </div>
//                         </label>
//                       </div>
//                     </div>
...
//                   <span>{lang === 'hi' ? 'कुल राशि:' : 'Total Payable:'}</span>
//                   <span className="text-xl font-black text-emerald-400">₹{totalAmount.toLocaleString('en-IN')}</span>
//                 </div>
...
//                   form="orderForm"
//                   disabled={isSubmitting}
//                   className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white py-3 rounded-xl text-xs font-black shadow-xs transition active:scale-95 flex items-center justify-center gap-1.5"
//                 >
//                   <ShieldCheck className="w-4 h-4" />
//                   <span>
//                     {isSubmitting 
...
export default function Marketplace() {
  ...
  // 1-Second Smooth Background Color Rotation
  useEffect(() => {
    const interval = setInterval(() => {
      setColorIndex((prev) => (prev + 1) % 10);
    }, 1000);
  ...
  const filteredProducts = marketplaceProducts.filter((item) => {
    ...
    if (!q) return matchTab && matchCrop;

    const nameEn = (item.nameEn || '').toLowerCase();
    const nameHi = (item.nameHi || '').toLowerCase();
    const targetEn = (item.targetEn || '').toLowerCase();
    const targetHi = (item.targetHi || '').toLowerCase();
  ...
  const saveOrderToDatabase = async (paymentRefId = 'COD_OR_LOCAL') => {
    try {
      ...
      const payload = {
        ...
        paymentType: formData.paymentMethod,
        paymentStatus:
          formData.paymentMethod === 'online' ? 'PAID' : 'PENDING_DELIVERY',
        transactionRef: paymentRefId,
        totalPayable: totalAmount,
        currency: 'INR',
        orderDate: serverTimestamp(),
  ...
  const handlePaymentExecution = () => {
    if (!window.Razorpay) {
      alert(
        lang === 'hi'
          ? 'पेमेंट गेटवे लोड हो रहा है, कृपया 2 सेकंड बाद पुनः प्रयास करें।'
          : 'Payment gateway is loading, please retry in 2 seconds.'
      );
      return;
    }

    const options = {
      key: "rzp_test_51NgU7u52JbC6G",
      amount: totalAmount * 100,
      currency: "INR",
      name: "AgriScan Precision Mart",
      description:
        lang === 'hi'
          ? 'प्रमाणित बीज व फसल दवा खरीद'
          : 'Procurement of Agricultural Chemicals & Seeds',
      image: "/image/1000201393.jpg",
      handler: function (response) {
        saveOrderToDatabase(response.razorpay_payment_id || 'RZP_TXN_VERIFIED');
      },
    ...
    rzp.on('payment.failed', function (response) {
      alert(
        (lang === 'hi' ? 'भुगतान असफल: ' : 'Payment Failed: ') +
          (response.error.description || 'Cancelled')
      );
    });
    rzp.open();
  };
